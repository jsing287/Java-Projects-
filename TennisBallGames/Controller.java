...
public class Controller implements Initializable {
    ...
    private TeamsAdapter teams; // team adapter field.
    private MatchesAdapter matches; // matches adapter.
    private Connection conn; // connection conn.

    @FXML
    private MenuBar mainMenu; // mainMenu MenuBar.
    ...
    public void addMatch() throws Exception {
        ...
        AddMatchController addMatchController = fxmlLoader.getController();
